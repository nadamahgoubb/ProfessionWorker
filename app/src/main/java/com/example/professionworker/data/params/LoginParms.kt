...
fun RegisterParams.toMap(): Map<String, RequestBody>{
    ...
    itemMap["national_id"] = national_id.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    ...
    itemMap["previous_experience"] = previous_experience.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    itemMap["years_experience"] = years_experience.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    itemMap["hour_price"] = hour_price.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    itemMap["paaword"] = paaword.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    itemMap["account_number"] = account_number.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    itemMap["account_name"] = account_name.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    itemMap["bank_id"] = bank_id.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
    itemMap["iban_number"] = iban_number.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
