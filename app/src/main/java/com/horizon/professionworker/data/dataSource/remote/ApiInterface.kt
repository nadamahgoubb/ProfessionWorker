package com.horizon.professionworker.data.dataSource.remote
...
interface ApiInterface {
    ...
    @POST("provider/login")
    suspend fun login(
        @Field("countryCode") countryCode: String,      @Field("phone") phone: String, @Field("password") password: String
